...
function services() {
  return (
    <div >
      <div className="box-content bg-white-100 h-[32rem] w-100 p-4 border-4 ">
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col">
      <div className="h-1 bg-white-200 rounded overflow-hidden">
        <div className="w-24 h-0 bg-indigo-500" />
      </div>
      <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
        <h1 className="sm:w-2/5 text-gray-900 font-medium title-font text-2xl mb-2 sm:mb-0">Our Services</h1>
        <p className="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">The field of farming and agriculture has benefited from advances in information technology like nearly every other global industry. Industry improvements show up in many areas from greenhouse construction and maintenance to evaluation of soil samples. However, modern farmers and economic development 
        planning teams look to the rapid advancements within the text messaging and mobile web sector as the latest opportunity for farmers to develop cost and competitive advantages.</p>
      </div>
    </div>
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      ...
      <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
        <div className="rounded-lg h-64 overflow-hidden">
          <img alt="content" className="object-cover object-center h-full w-full" src="https://tse4.mm.bing.net/th?id=OIP.oVynkEkZ21YabjVa6rz27wHaE8&pid=Api&P=0" />
        </div>
      ...
      <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
        <div className="rounded-lg h-64 overflow-hidden">
          <img alt="content" className="object-cover object-center h-full w-full" src="https://tse1.mm.bing.net/th?id=OIP.IE-1k93w96fMc0Hvc9BHtgHaE8&pid=Api&P=0" />
        </div>
